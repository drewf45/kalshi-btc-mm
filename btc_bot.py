...
def main() -> None:
    ...
    while True:
        ...
        # Counterparty check — skip at safety net (T=10s), just place and let Kalshi handle it
        ...
        if not _in_safety_net:
            ...
            log.info(f"[SAFETY-NET] Skipping counterparty check at T={secs_to_close:.0f}s — placing order")
