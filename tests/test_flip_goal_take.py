...
def test_take_is_orientation_correct_no_mirrors_yes(flip):
    ...
    assert y.price_cents == n.price_cents == 64
...
def test_take_caps_at_90(flip):
    ...
    exits = _take_prop(flip, "yes", 90, 90)   # 90+4=94 → capped 90
