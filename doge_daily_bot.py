...
print(f"BOOT: doge_daily_bot.py v5 loaded at {datetime.now(timezone.utc).isoformat()}Z", flush=True)

# ======================== LOGGING ============================
LOG_LEVEL = os.getenv("LOG_LEVEL", "INFO").upper()
logging.basicConfig(level=LOG_LEVEL, format="%(asctime)s %(levelname)s %(message)s")
log = logging.getLogger("kalshi-doge-daily")
...
# ======================== CONFIGURATION ======================
BOT_ID          = "DOGE"
SERIES_TICKER   = getenv_first(["SERIES", "KALSHI_SERIES"], "KXDOGED")
...
SPOT_URL = "https://api.coinbase.com/v2/prices/DOGE-USD/spot"
...
def main() -> None:
    ...
    log.warning("=" * 60)
    log.warning(f"[BOT] DOGE DAILY — PARTICIPATION-FIRST V5")
